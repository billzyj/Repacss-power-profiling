...
class H100PowerQueryRunner:
    ...
    def get_power_analysis(self):
        ...
        try:
            ...
            results['H100_Node_Power_Comparison'] = df_node_comparison
            ...
            results['H100_Power_Efficiency_Analysis'] = df_efficiency
            ...
            results['H100_Power_Consumption_Trends'] = df_consumption_trends
            ...
            results['H100_High_Power_Usage_Alerts'] = df_high_power
            ...
            results['H100_Power_Efficiency_By_Node'] = df_efficiency_by_node
    ...
    def get_time_range_analysis(self, hours: int = 24):
        """Get H100 time range power analysis"""
        try:
            print(f"📊 Collecting H100 {hours}-hour time range analysis...")
        ...
        end_time = datetime.now()
            ...
            results[f'H100_Power_Summary_{hours}h'] = df_power_summary
            ...
            results[f'H100_CPU_Power_Summary_{hours}h'] = df_cpu_summary
            
            # GPU power summary for time range (using gpu1power as representative)
            gpu_summary_query = f"""
            SELECT 
                nodeid,
            ...
            results[f'H100_GPU_Power_Summary_{hours}h'] = df_gpu_summary
...
def main():
    ...
    try:
        ...
        if output_file:
            print(f"\nH100 power queries report summary:")
